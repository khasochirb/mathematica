"""The ЭШ prerequisite skill graph — source of truth.
...
ALGEBRA_CORE = [
    ...
    S("vieta-formulas", "algebra", "Relate the sum and product of roots to the coefficients", 3, 4,
      ...
      note="Heavily used in ЭШ — it answers 'find the sum of the roots' without solving."),
...
def emit(skills, by_id):
    ...
    lines += [
        ...
        f"    raise exception 'expected at least {len(rows)} ЭШ skills, found %', n_skills;",
        "  end if;",
        "",
