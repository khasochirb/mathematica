...
similarity: every ЭЕШ mapping below was checked against the ACTUAL QUESTION
...
THE CROSS-HUB COLLISION, settled. ЭЕШ carries `geometry` and `trigonometry`
as separate topics; SAT carries `geometry-trig` as one. The skills table
settles it: ЭЕШ topics geometry, trigonometry AND linear_algebra all sit in
...
m("esh", "probability", "variance (hypergeometric)", ["variance-of-random-variable"], 1, "high",
  ...
  note="'hypergeometric' is a red herring — at ЭЕШ level this is built from a distribution "
...
def main():
    ...
    out = {
        "note": "Generated by scripts/skills/topic_mapping.py. Every ЭЕШ row was verified "
