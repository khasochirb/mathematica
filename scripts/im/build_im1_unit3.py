    ...
    return lesson(
        ...
        steps=[
            ...
            },
            {
                ...
                "teach": (
                    "Each stage adds a fixed number of squares. Because the addition never "
                    "changes size, the totals climb in a straight line — which is exactly why an "
                    "arithmetic sequence turns out to be a linear function."
                ),
