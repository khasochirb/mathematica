...
update_file() {
    ...
    /<!-- Main -->/ {
        ...
        print "                                    </a>";
        print "                                    <a href=\"../../exam-prep.html#act\" class=\"dropdown-item\">";
        print "                                        <i class=\"fas fa-check-circle\"></i>";
        print "                                        <span>ACT Math</span>";
        print "                                    </a>";
        print "                                    <a href=\"../../exam-prep.html#psat\" class=\"dropdown-item\">";
        print "                                        <i class=\"fas fa-clipboard-check\"></i>";
        print "                                        <span>PSAT/NMSQT</span>";
        print "                                    </a>";
        print "                                    <a href=\"../../exam-prep.html#gre\" class=\"dropdown-item\">";
        print "                                        <i class=\"fas fa-chart-line\"></i>";
        print "                                        <span>GRE Quant</span>";
        print "                                    </a>";
        print "                                    <a href=\"../../exam-prep.html#gmat\" class=\"dropdown-item\">";
        print "                                        <i class=\"fas fa-briefcase\"></i>";
        print "                                        <span>GMAT Quant</span>";
        print "                                    </a>";
        print "                                    <a href=\"../../exam-prep.html#ib\" class=\"dropdown-item\">";
        print "                                        <i class=\"fas fa-globe\"></i>";
        print "                                        <span>IB Math</span>";
        print "                                    </a>";
        print "                                    <a href=\"../../exam-prep.html#igcse\" class=\"dropdown-item\">";
        print "                                        <i class=\"fas fa-book\"></i>";
        print "                                        <span>IGCSE/GCSE Math</span>";
        print "                                    </a>";
        ...
        print "                                </li>";
        print "";
        print "                                <!-- About Us Dropdown -->";
        print "                                <li class=\"has-dropdown\">";
        print "                                    <a href=\"../../company.html\">About Us</a>";
        print "                                    <div class=\"dropdown\">";
        print "                                        <div class=\"dropdown-grid\">";
