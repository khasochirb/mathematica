...
export const NAV: ChromeEntry[] = [
  ...
  { en: "Back to the SAT hub", mn: "SAT Math төв рүү буцах", src: "NEW", n: 1, ok: "2026-09-13", note: "SAT stays Latin (glossary rule 2)" },
  { en: "Back to the IB hub", mn: "IB Math төв рүү буцах", src: "NEW", n: 1, ok: "2026-09-13" },
  ...
  { en: "ЭШ Hub", mn: "ЭШ төв", src: "SITE", n: 1, note: 'matches the existing "Back to the SAT hub"→«SAT хэсэг рүү буцах»' },
  ...
  { en: "SAT Math Hub", mn: "SAT Math төв", src: "SITE", n: 1, note: "SAT/IB course names stay Latin; only «хэсэг» is translated" },
  { en: "IB Math Hub", mn: "IB Math төв", src: "SITE", n: 1 },
...
export const CONTROLS: ChromeEntry[] = [
  ...
  { en: "Move left", mn: "Зүүн тийш зөөх", src: "NEW", n: 2, ok: "2026-09-13", note: "Khas, 13 Sep 2026 — gains the verb «зөөх» so it matches the other Move entries instead of standing as a bare adverb." },
  { en: "Move right", mn: "Баруун тийш зөөх", ok: "2026-09-13", src: "NEW", n: 2 },
...
export const WIDGETS: ChromeEntry[] = [
  ...
  { en: "More pieces", mn: "Хэсэг нэмэх", src: "NEW", note: "bare object, not accusative — the site's own Mongolian writes «Рационал тоо нэмэх», «Бүхэл тоо хасах», «Татвар, цайны мөнгө нэмэх»; the one corpus accusative («Сөрөгийг хасах») has a definite object, which a generic ± button does not. Was «Хэсгийг нэмэх» etc., over-marked in 10 of 12." },
  { en: "Fewer pieces", mn: "Хэсэг хасах", src: "NEW" },
  { en: "More sides", mn: "Тал нэмэх", src: "NEW" },
  { en: "Fewer sides", mn: "Тал хасах", src: "NEW" },
  { en: "More units", mn: "Нэгж нэмэх", src: "DERIV", note: "«нэгж» from the Unit entry" },
  { en: "Fewer units", mn: "Нэгж хасах", src: "DERIV" },
  { en: "More batches", mn: "Багц нэмэх", src: "NEW" },
  { en: "Fewer batches", mn: "Багц хасах", src: "NEW" },
  { en: "More x", mn: "x нэмэх", src: "NEW" },
  { en: "Fewer x", mn: "x хасах", src: "NEW" },
  ...
  { en: "Reset pattern", mn: "Зүй тогтлыг дахин эхлүүлэх", src: "DERIV", ok: "2026-09-13", note: "Khas, 13 Sep 2026: «pattern» is «зүй тогтол», not «хэв маяг», and the oblique drops a vowel — тогтол becomes тогтлыг. PatternGrow reveals a growing pattern whose rule the student is meant to infer, so «зүй тогтол» (regularity) is the sense. SEE THE REVIEW QUEUE: «хэв маяг» stands in 7 places in shipped mirrors, so this splits the word." },
  { en: "Reset tree", mn: "Модыг цэвэрлэх", src: "DERIV", ok: "2026-09-13", note: "Khas, 13 Sep 2026 — and he confined it: «цэвэрлэх is only for the trees». Every other reset on the site is «дахин эхлүүлэх». This is the exception, not the head of a family." },
  { en: "Reset proof", mn: "Баталгааг дахин эхлүүлэх", src: "DERIV", ok: "2026-09-13", note: "«дахин эхлүүлэх» is the default; Khas confined «цэвэрлэх» to the tree on 13 Sep 2026." },
  { en: "Reset tests", mn: "Шалгалтыг дахин эхлүүлэх", src: "NEW", ok: "2026-09-13", note: "Khas, 13 Sep 2026: «цэвэрлэх» is ONLY for the tree. My build-vs-run rule was over-generalised from his one example — this is the correction." },
  ...
  { en: "Coordinate grid", mn: "Координатын тор", src: "NEW", note: "«тор» (grid), deliberately not «хавтгай» (plane). The corpus attests only «координатын хавтгай» (4 uses), but that names the abstract space; this alt-text describes the drawn lattice a figure actually shows. Unattested in that sense — flagged." },
  ...
  { en: "A complex number plotted on the Argand diagram", mn: "Аргандын диаграмм дээр байрлуулсан комплекс тоо", src: "NEW", note: "«Аргандын», not «Арганы» — the mathematician is Jean-Robert ARGAND, so the Cyrillic stem keeps its final д. Corrected 13 Sep 2026; the earlier note said «Argand → Арган», which is what dropped it. No corpus precedent for the name anywhere, so the rendering still wants confirming." },
  { en: "A conic section on a grid", mn: "Тор дээрх конус огтлол", src: "NEW", note: "«конус огтлол» is UNATTESTED — zero uses in А/492, the ЭШ bank and every shipped mirror. Mine, and unverified." },
  ...
  { en: "A point orbiting a circle traces a sine wave", mn: "Тойргийг тойрон эргэх цэг синус долгион зурна", src: "NEW", note: "«синус долгион» is UNATTESTED — zero uses anywhere in the corpus. Mine, and unverified." },
  ...
  { en: "Powers of a complex number spiralling on the Argand diagram", mn: "Аргандын диаграмм дээр мушгирч буй комплекс тооны зэргүүд", src: "NEW" },
