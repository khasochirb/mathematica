...
export const WIDGETS: ChromeEntry[] = [
  ...
  { en: "Reset tree", mn: "Модыг цэвэрлэх", src: "DERIV", ok: "2026-09-13", note: "Khas, 13 Sep 2026. «цэвэрлэх» (clear), not «дахин эхлүүлэх» — the student BUILDS this tree up, so resetting clears what they made. Contrast Reset pattern, which he left as «дахин эхлүүлэх» because that widget runs rather than accumulates." },
  { en: "Reset proof", mn: "Баталгааг дахин эхлүүлэх", src: "DERIV" },
  { en: "Reset tests", mn: "Шалгалтыг цэвэрлэх", src: "NEW", note: "DERIVED, not ruled. Follows the line Khas's two verbs draw on 13 Sep 2026: ConjectureTest piles up tap-by-tap results like the tree, so it clears; StepProof only reveals rows, so it keeps «дахин эхлүүлэх»." },
