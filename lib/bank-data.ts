...
import grade3 from "@/data/problembank/2.json";
import grade4 from "@/data/problembank/3.json";
import grade5 from "@/data/problembank/4.json";
...
import grade10 from "@/data/problembank/10.json";
import grade11 from "@/data/problembank/11.json";
...
const TOPICS: BankTopic[] = [
  ...
  integrated2,
  integrated3,
  // Primary and middle band (slugs mirror the course paths /math/3 ...),
  // one collection per unit of each year.
  grade3,
  grade4,
  grade5,
  grade6,
