      ...
      <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 pt-10 pb-16">
        ...
        <ol className="space-y-3 mb-10">
          {topic.lessons.map((lesson, i) => (
            <li key={lesson.slug}>
              <Link
                href={`/math/3/${topicSlug}/${lesson.slug}`}
        ...
        {/* Practice + Test buttons, and this unit's own problem bank — every
            Grade 3 unit has its own collection (see scripts/pb/grade4.py). */}
        <div className="flex gap-3 flex-wrap">
          <Link href={`/math/3/${topicSlug}/practice`} className="btn btn-primary">
            {mn ? "Дасгал" : "Practice"}
          </Link>
          <Link href={`/math/3/${topicSlug}/test`} className="btn btn-line">
