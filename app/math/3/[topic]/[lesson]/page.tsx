...
function GenMathLessonPageInner() {
  ...
  if (lesson.interactive) {
    return <LessonPlayer lesson={lesson} topicSlug={topicSlug} topicTitle={topic.title} baseHref={`/math/3/${topicSlug}`} crumb={`${mn ? "Хичээлүүд · 3-р анги" : "Courses · Grade 3"} · ${topic.title}`} />;
  }
