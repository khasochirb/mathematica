      ...
      <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 pt-10 pb-16">
        ...
        <ol className="space-y-3 mb-10">
          {topic.lessons.map((lesson, i) => (
            <li key={lesson.slug}>
              <Link
                href={`/math/12/${topicSlug}/${lesson.slug}`}
        ...
        <div className="flex gap-3 flex-wrap">
          <Link href={`/math/12/${topicSlug}/practice`} className="btn btn-primary">
            {mn ? "Дасгал" : "Practice"}
          </Link>
          <Link href={`/math/12/${topicSlug}/test`} className="btn btn-line">
