...
import { getAlg1Spine } from "@/lib/genmath-data/algebra-1";
...
export default function Alg1CoursePage() {
  const spine = getAlg1Spine();
    ...
    <div className="min-h-screen pt-20" style={{ background: "var(--bg)" }}>
      <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 pt-10 pb-16">
        ...
        <p className="mt-4 mb-8" style={{ color: "var(--fg-1)", fontSize: 17, maxWidth: "56ch" }}>
          The language the rest of mathematics is written in: expressions and
          equations, inequalities, functions and their graphs, lines, systems,
        ...
        <ol className="space-y-3">
          {spine.map((u) => {
            return u.live ? (
              <li key={u.slug}>
                <TopicLink courseKey="algebra-1" topicSlug={u.slug}                   href={`/math/algebra-1/${u.slug}`}
