...
function GenMathLessonPageInner() {
  ...
  if (lesson.interactive) {
    return <LessonPlayer lesson={lesson} topicSlug={topicSlug} topicTitle={topic.title} baseHref={`/math/2/${topicSlug}`} crumb={`${mn ? "Хичээлүүд · 2-р анги" : "Courses · Grade 2"} · ${topic.title}`} />;
  }
