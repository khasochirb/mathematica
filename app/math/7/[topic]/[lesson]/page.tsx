...
function GenMathLessonPageInner() {
  ...
  if (lesson.interactive) {
    return <LessonPlayer lesson={lesson} topicSlug={topicSlug} topicTitle={topic.title} baseHref={`/math/7/${topicSlug}`} crumb={`${mn ? "Ерөнхий математик · 7-р анги" : "General Math · Grade 7"} · ${topic.title}`} />;
  }
