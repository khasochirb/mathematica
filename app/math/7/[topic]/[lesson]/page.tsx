...
function GenMathLessonPageInner() {
  ...
  if (lesson.interactive) {
    return <LessonPlayer lesson={lesson} topicSlug={topicSlug} topicTitle={topic.title} baseHref={`/math/7/${topicSlug}`} crumb={`${mn ? "Хичээлүүд · 7-р анги" : "Courses · Grade 7"} · ${topic.title}`} />;
  }
