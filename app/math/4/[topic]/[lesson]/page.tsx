...
function GenMathLessonPageInner() {
  ...
  if (lesson.interactive) {
    return <LessonPlayer lesson={lesson} topicSlug={topicSlug} topicTitle={topic.title} baseHref={`/math/4/${topicSlug}`} crumb={`${mn ? "Хичээлүүд · 4-р анги" : "Courses · Grade 4"} · ${topic.title}`} />;
  }
