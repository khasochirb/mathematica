...
export default function VecMatCoursePage() {
  const spine = getVecMatSpine();
    ...
    <div className="min-h-screen pt-20" style={{ background: "var(--bg)" }}>
      <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 pt-10 pb-16">
        ...
        <p className="mt-4 mb-8" style={{ color: "var(--fg-1)", fontSize: 17, maxWidth: "56ch" }}>
          Arrows made of numbers, then grids that move them. Vectors in the plane
          and in space — components, dot products, geometry — followed by matrices,
        ...
        <CoursePlacementCta
          ...
          href="/math/vectors-matrices/placement"
