...
export const metadata: Metadata = {
  ...
  // PWA / installable-app metadata. The manifest is generated by app/manifest.ts.
...
// Next 14 requires viewport + themeColor in their own export (not in metadata).
// viewportFit "cover" lets content extend under the iOS notch/safe-area when
// installed. themeColor matches the light --bg (the app's default theme).
