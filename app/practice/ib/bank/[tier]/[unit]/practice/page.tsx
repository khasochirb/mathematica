...
export function generateMetadata({ params }: { params: { tier: string; unit: string } }) {
  ...
  return { title: unit ? `IB Math · ${unit.title} · Practice` : "IB Math · Topic Practice" };
}

export default function IbBankUnitPracticePage({ params }: { params: { tier: string; unit: string } }) {
