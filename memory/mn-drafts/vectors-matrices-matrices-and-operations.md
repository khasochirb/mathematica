...
| 10 | funFact | **eyebrow** Сонирхолтой баримт · **title** Нэр нь хэрэгслээсээ түрүүлсэн<br>**body** Жеймс Сильвестр 1850 онд «matrix» гэдэг нэрийг зохиосон. Латинаар «умай» гэсэн үг: тэр энэ хүснэгтийг тодорхойлогчид ТӨРДӨГ эх гэж харжээ. Түүний найз Артур Кэйли дараа нь таны одоо сурах гэж буй алгебрыг бүтээсэн. |
...
- **«Кэйли»** (Cayley, lesson 1 funFact): the spelling of every bank solution
  («Кэйли-Гамильтоны теоремоор») and of `data/i18n/mn-skill-names.json`. The
  bank's subtopic tag spells it «Кэли»; that split is logged there, not new.
