...
олонлогийн **чадал** гэж нэрлэдэг ба бодлогын нөхцөлд «$|X|$ нь $X$ олонлогийн
...
- **WORKING:** Дунд муж: $A \cap B = \{4, 5, 6\}$, иймд $|A \cap B| = 3$.
  ...
  $|A| + |B| - |A \cap B| = 6 + 5 - 3 = 8$ гэж бодвол мөн ижил хариу, учир нь дунд
...
| 7 | recap | **title** Санаж үлдэх зүйл<br>**points** Дөрвөн муж: зөвхөн $A$, хоёулаа, зөвхөн $B$, аль нь ч биш; бүх тоо эдгээрийн нийлбэр · $\cup$ эсвэл, $\cap$ ба, $\setminus$ боловч-биш (чиглэлтэй!), $\overline{A}$ үлдсэн бүх зүйл · $\|\overline{A}\| = \|U\| - \|A\|$ нь хэцүү тоололтыг хасалт болгоно |
...
- **ANSWER:** $16$
- **WORKING:** $a$ асаалттай, $b$ унтраалттай тогтсон бол дөрвөн элемент
  чөлөөтэй: $2^4 = 16$.
...
тэдгээрийг андуурвал бүх тооцоо буруу явна. **«Аль нь ч биш»** гэдэг нь хоёуланд нь
ороогүй, өөрөөр хэлбэл $\overline{A \cup B}$, тоо нь $|U| - |A \cup B|$.
**«Хоёулаа биш»** гэдэг нь ядаж нэгэнд нь ороогүй, өөрөөр хэлбэл
$\overline{A \cap B}$, тоо нь $|U| - |A \cap B|$. **«Дор хаяж нэг нь»** гэдэг нь
...
$A \cup (B \cap C) = (A \cup B) \cap (A \cup C)$, харин арифметикт ийм зүйл
...
- **WORKING:** «Аль алинд нь тэнцээгүй» гэдэг нь Де Морганаар
  ...
  гэсэн тоо энд огт хэрэггүй, учир нь асуулт зөвхөн гүйцээлтээс шалтгаалж байна. ЭШ
...
олонлогууд нь үлдсэн гурван элементийн дэд олонлогууд, өөрөөр хэлбэл $2^3 = 8$. Иймд
$2^5 - 8 = 32 - 8 = 24$.
...
> (i) худал, учир нь $A$-ийн элементүүд нь $2$ ба $\{3\}$ гэсэн ОЛОНЛОГ
