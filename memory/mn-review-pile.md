...
switched to ЭШ-first: this file now covers **fifty-eight drafts**, fifty-one
...
> **ЭШ progress, 23 Sep: 55 of 72 units covered · 11 of 14 topics** — counting
...
>
> Remaining, by distance-to-complete: Тригонометр (3 — units 1–3 drafted
> 23 Sep), Анализын эхлэл (6), Вектор ба матриц (8).
...
fifty-eight drafts carry zero em-dash parentheticals in shipping prose, and
...
### 2d. Math-mode decimals — **not applied. Surveyed: 1,454 of them.**
