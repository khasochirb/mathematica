-- ============================================================
-- 012: close the self-serve premium hole on profiles
-- ============================================================
...
-- 20260815104638.
--
-- Renumbered 011 → 012 so that 011 stays free for Stream B's
-- 011_seed_esh_graph.sql, which is generated by scripts/skills/esh_graph.py
-- and cannot easily be renamed on their side. Nothing here touches the same
-- objects as 010 or 011, so the order between them does not matter.
--
